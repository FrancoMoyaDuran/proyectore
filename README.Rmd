...
Launch the [`make.R`](https://github.com/FrancoMoyaDuran/proyectore/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/FrancoMoyaDuran/proyectore/blob/main/CONTRIBUTING.md).
